...
export default function IPhone(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("/models/phone/scene.glb");

  // eslint-disable-next-line react/prop-types
  const texture = useTexture(props.texture ? props.texture : '/models/phone/default.png');
  ...
  useEffect(() => {
    Object.entries(materials).map((material) => {
      ...
      if (
        ...
        material[1].color = new THREE.Color('#FFE7B9');
      }
  ...
  return (
    <group scale={14} position={[0, 1.3, 0]} rotation={[0, 4, 0]} ref={group} {...props} dispose={null}>
      <mesh
        castShadow
        receiveShadow
...
useGLTF.preload("/models/phone/scene.glb");
